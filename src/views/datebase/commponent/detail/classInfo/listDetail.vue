        ...
        <div class="wbc-modal-content" @click="outerClickCloseModal">
          ...
          >
            ...
            <div class="wbcModalImageContent-slideImg-textBox">
              <p class="wbcModalImageContent-slideImg-x-text">X: {{ Math.round(Number(wpsJsonData[0].x1) + (xyResolution.X * wbcXYPos.posX)) }} mm</p>
              <p class="wbcModalImageContent-slideImg-y-text">Y: {{ Math.round(Number(wpsJsonData[0].y1) + (xyResolution.Y * wbcXYPos.posY)) }} mm</p>
            </div>
