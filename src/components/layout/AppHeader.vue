  ...
  try {
    ...
    if (result) {
      if (result?.data) {
        ...
        sessionStorage.setItem('wbcPositionMargin', result.data?.wbcPositionMargin);
        sessionStorage.setItem('rbcPositionMargin', result.data?.rbcPositionMargin);
        sessionStorage.setItem('pltPositionMargin', result.data?.pltPositionMargin);
