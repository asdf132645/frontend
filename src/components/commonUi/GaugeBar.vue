...
.circleGuage.completed .circleChild {
  background-color: #2e2e2e;
  color: white;
  border-color: #00c2ff;
}

.circleGuage.active .circleChild {
  background-color: #ffffff;
  color: black;
  border-color: #00c2ff;
}

.circleGuage.waiting .circleChild {
...
.circleGuage.waitingStep .circleChild, .circleGuage.completedStep .circleChild {
  width: 30px;
  height: 30px;
}

.circleGuage.completedStep > .circleChild {
  background: #1c1d1e;
  color: #00c2ff;
