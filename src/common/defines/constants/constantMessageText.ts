export const enum MESSAGES {
    ...
    TOAST_MSG_LIS_UPLOAD_SCROLL = 'Please check all cell for LIS Upload',
...
export const MSG = {
    TOOLTIP: {
        ...
        KEEP_PAGE: 'Keep the current tab when using up and down arrows',
        ...
        LIS_UPLOAD_CHECK: 'Verify Cells for LIS (HIS) Upload',
        MOVE_PAGE_AFTER_LIS: 'Move to the Next Slide Data After LIS(HIS) Upload',
